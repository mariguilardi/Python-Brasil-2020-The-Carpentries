...
```{r echo=FALSE, out.width="50%", fig.align='center' , fig.cap="Legenda: Imagem do Repositório no GitHub do material do workshop sobre ecologia, da Data Carpentry "}
...
```{r echo=FALSE, out.width="50%", fig.align='center', fig.cap="Legenda: Imagem do site do projeto Glossário, em Português. O logo é um papagaio azul e amarelo, com duas folhas verdes em frente. Aparecem na imagem alguns termos em português, seus significados, alguns termos relacionados, e idiomas em que o termo foi traduzido."}
...
```{r echo=FALSE, out.width="60%", fig.align='center',  fig.cap="Legenda: Imagem do mapa do mundo mostrando a localização das pessoas instrutoras da Carpentries.  No Brasil aparecem poucas pessoas."}
...
```{r echo=FALSE, out.width="50%", fig.align='center', fig.cap="Legenda: Imagem do mapa do mundo mostrando a localização das pessoas instrutoras da Carpentries.  No Brasil aparecem 5 pessoas."}
...
Apresentação disponível [neste link](https://mariguilardi.github.io/Python-Brasil-2020-The-Carpentries/)

<!-- m: vou criar bit.ly para apresentação --> 
