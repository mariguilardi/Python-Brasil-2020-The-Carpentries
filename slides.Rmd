...
- The Carpentries é uma comunidade global que tem como missão desenvolver capacidade global em dados essenciais e habilidades computacionais para a realização de pesquisas eficientes, abertas e reproduzíveis. 

- O projeto Carpentries compreende as comunidades: [Software Carpentry](https://software-carpentry.org/), [Data Carpentry](http://www.datacarpentry.org/), e [Library Carpentry](https://librarycarpentry.org/), treinadores, mantenedores, ajudantes e apoiadores que compartilham a missão de ensinar habilidades básicas de computação e ciência de dados para pesquisadores.
...
Explicar o que é Software, Data e Library Carpentry?
...
1. Mostrar cortesia e respeitar com as outras pessoas que fazem parte da comunidade
